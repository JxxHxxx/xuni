...
class StudyProductCreateControllerTest extends StudyProductCommon{
    ...
    void create_detail_success() throws Exception {
        ...
        List<StudyProductDetailForm> form = List.of(
                new StudyProductDetailForm("spring IOC"),
                new StudyProductDetailForm("spring AOP"),
                new StudyProductDetailForm("spring MVC"));
